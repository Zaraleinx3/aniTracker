  ...
  return (
    <section>
      ...
      <AtAccordion
        ...
        onChange={handleAccordionChange("series")}
      >
        <AtAccordionSummary
          aria-controls="series-content"
          id="searchSeriesAccordion"
        >
          Series
        </AtAccordionSummary>
        <AtAccordionDetails>
      ...
      <AtAccordion
        ...
        onChange={handleAccordionChange("movies")}
      >
        <AtAccordionSummary
          aria-controls="movies-content"
          id="searchMoviesAccordion"
        >
          Movies
        </AtAccordionSummary>
        <AtAccordionDetails>
...
Search.propTypes = {
  ...
  multiSearchMovieDB: PropTypes.func.isRequired,
};
...
const mapDispatchToProps = (dispatch) => ({
  multiSearchMovieDB: (searchValue) =>
    dispatch(multiSearchMovieDB(searchValue)),
});
